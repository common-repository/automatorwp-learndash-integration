...
class AutomatorWP_LearnDash_Mark_Lesson extends AutomatorWP_Integration_Action {
    ...
    public function register() {
        ...
        automatorwp_register_action( $this->action, array(
            ...
            'label'             => __( 'Mark lesson as completed', 'automatorwp-learndash' ),
            'select_option'     => __( 'Mark lesson as <strong>completed</strong>', 'automatorwp-learndash' ),
            /* translators: %1$s: Post title. */
            'edit_label'        => sprintf( __( 'Mark %1$s as completed', 'automatorwp-learndash' ), '{post}' ),
            /* translators: %1$s: Post title. */
            'log_label'         => sprintf( __( 'Mark %1$s as completed', 'automatorwp-learndash' ), '{post}' ),
            'options'           => array(
                'post' => automatorwp_utilities_post_option( array(
                    'name'              => __( 'Lesson:', 'automatorwp-learndash' ),
                    'option_none_label' => __( 'all lessons', 'automatorwp-learndash' ),
                    'option_custom'         => true,
                    'option_custom_desc'    => __( 'Lesson ID', 'automatorwp-learndash' ),
