...
class AutomatorWP_LearnDash_Mark_Topic extends AutomatorWP_Integration_Action {
    ...
    public function register() {
        ...
        automatorwp_register_action( $this->action, array(
            ...
            'label'             => __( 'Mark topic as completed', 'automatorwp-learndash' ),
            'select_option'     => __( 'Mark topic as <strong>completed</strong>', 'automatorwp-learndash' ),
            ...
            'options'           => array(
                'post' => automatorwp_utilities_post_option( array(
                    'name'              => __( 'Topic:', 'automatorwp-learndash' ),
                    'option_none_label' => __( 'all topics', 'automatorwp-learndash' ),
                    'option_custom'         => true,
                    'option_custom_desc'    => __( 'Yopic ID', 'automatorwp-learndash' ),
