...
class AutomatorWP_LearnDash_User_Group extends AutomatorWP_Integration_Action {
    ...
    public function register() {
        ...
        automatorwp_register_action( $this->action, array(
            ...
            'label'             => __( 'Add user to a group', 'automatorwp-learndash' ),
            'select_option'     => __( 'Add user to <strong>a group</strong>', 'automatorwp-learndash' ),
            /* translators: %1$s: Post title. */
            'edit_label'        => sprintf( __( 'Add user to %1$s', 'automatorwp-learndash' ), '{post}' ),
            /* translators: %1$s: Post title. */
            'log_label'         => sprintf( __( 'Add user to %1$s', 'automatorwp-learndash' ), '{post}' ),
            'options'           => array(
                'post' => automatorwp_utilities_post_option( array(
                    'name'              => __( 'Group:', 'automatorwp-learndash' ),
                    'option_none_label' => __( 'all groups', 'automatorwp-learndash' ),
                    'option_custom'         => true,
