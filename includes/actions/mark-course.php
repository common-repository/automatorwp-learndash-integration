...
class AutomatorWP_LearnDash_Mark_Course extends AutomatorWP_Integration_Action {
    ...
    public function register() {
        ...
        automatorwp_register_action( $this->action, array(
            ...
            'label'             => __( 'Mark course as completed', 'automatorwp-learndash' ),
            'select_option'     => __( 'Mark course as <strong>completed</strong>', 'automatorwp-learndash' ),
            ...
            'options'           => array(
                'post' => automatorwp_utilities_post_option( array(
                    'name'              => __( 'Course:', 'automatorwp-learndash' ),
                    'option_none_label' => __( 'all courses', 'automatorwp-learndash' ),
                    'option_custom'         => true,
