...
class AutomatorWP_LearnDash_Create_Group extends AutomatorWP_Integration_Action {
    ...
    public function register() {
        ...
        automatorwp_register_action( $this->action, array(
            ...
            'label'             => __( 'Create a group', 'automatorwp-learndash' ),
            'select_option'     => __( 'Create a <strong>group</strong>', 'automatorwp-learndash' ),
            /* translators: %1$s: Group. */
            'edit_label'        => sprintf( __( 'Create a %1$s', 'automatorwp-learndash' ), '{group}' ),
            /* translators: %1$s: Group. */
            'log_label'         => sprintf( __( 'Create a %1$s', 'automatorwp-learndash' ), '{group}' ),
            'options'           => array(
                'group' => array(
                    'default' => __( 'group', 'automatorwp-learndash' ),
                    'fields' => array(
                        'post_title' => array(
                            'name' => __( 'Group name:', 'automatorwp-learndash' ),
                            'type' => 'text',
                        ),
                        'post' => automatorwp_utilities_post_field( array(
                            'name'              => __( 'Group course:', 'automatorwp-learndash' ),
                            'option_none'       => false,
                            'option_custom'         => true,
                            'option_custom_desc'    => __( 'Course ID', 'automatorwp-learndash' ),
                            'post_type'         => 'sfwd-courses',
                            'placeholder'       => __( 'Select a course', 'automatorwp-learndash' ),
                            'default'           => ''
                        ) ),
