...
class AutomatorWP_LearnDash_Complete_Topic extends AutomatorWP_Integration_Trigger {
    ...
    public function register() {
        ...
        automatorwp_register_trigger( $this->trigger, array(
            ...
            'label'             => __( 'User completes a topic', 'automatorwp-learndash-integration' ),
            'select_option'     => __( 'User completes <strong>a topic</strong>', 'automatorwp-learndash-integration' ),
            ...
            'options'           => array(
                'post' => automatorwp_utilities_post_option( array(
                    'name' => __( 'Topic:', 'automatorwp-learndash-integration' ),
                    'option_none_label' => __( 'any topic', 'automatorwp-learndash-integration' ),
