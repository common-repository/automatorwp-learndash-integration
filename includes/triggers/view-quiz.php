...
class AutomatorWP_LearnDash_View_Quiz extends AutomatorWP_Integration_Trigger {
    ...
    public function register() {
        ...
        automatorwp_register_trigger( $this->trigger, array(
            ...
            'label'             => __( 'User views a quiz', 'automatorwp-learndash' ),
            'select_option'     => __( 'User views <strong>a quiz</strong>', 'automatorwp-learndash' ),
            ...
            'tags' => array_merge(
                automatorwp_utilities_post_tags( __( 'Quiz', 'automatorwp-learndash' ) ),
